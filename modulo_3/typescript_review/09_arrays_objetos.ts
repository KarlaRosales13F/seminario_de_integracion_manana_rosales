...
const catalogo: Producto[] = [
  { id: 1, nombre: "Laptop",  precio: 999,  disponible: true, existencia: 10 },
  { id: 2, nombre: "Mouse",   precio: 25,   disponible: true, existencia: 5 },
  { id: 3, nombre: "Monitor", precio: 350,  disponible: false, existencia: 5 },
  {id: 4, nombre: "Teclado", precio: 75, disponible: true, existencia: 15 },
  {id: 5, nombre: "Auriculares", precio: 50, disponible: false, existencia: 5 }
];
