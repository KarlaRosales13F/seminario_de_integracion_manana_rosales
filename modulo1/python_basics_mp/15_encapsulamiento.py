...
class TarjetaFidelizacion:
    def __init__(self, titular, saldo_inicial=0):
        ...
        self.__historial = []
        self.__activa   = True
        self.__registrar(f"Tarjeta creada con {saldo_inicial}€")
    ...
    def __str__(self):
        return f"TarjetaFidelizacion({self.titular}: {self.__saldo}€)"

# Uso
c1 = TarjetaFidelizacion("Ana García", 1000)
c2 = TarjetaFidelizacion("Luis Pérez", 500)

c1.depositar(500).retirar(200)     # encadenamiento — depositar y retirar devuelven self
c1.transferir(c2, 300)

print(c1)    # TarjetaFidelizacion(Ana García: 1000€)
print(c2)    # TarjetaFidelizacion(Luis Pérez: 800€)
